	...
	var factory = function (exports) {
		...
		exports.fn.tableDialog = function() {
			...
			var dialogContent = [
				...
				"<span>" + dialogLang.rows + "</span>" + " <input type=\"number\" value=\"3\" class=\"number-input\" style=\"width:50px;\" max=\"100\" min=\"2\" data-rows />&nbsp;&nbsp;",
				"<span>" + dialogLang.cols + "</span>" + " <input type=\"number\" value=\"2\" class=\"number-input\" style=\"width:50px;\" max=\"100\" min=\"1\" data-cols /><br/>",
				"<label style=\"line-height: 40px;\">" + dialogLang.alignLabel + "</label>",

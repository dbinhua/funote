                    ...
                    <form class="ui form" method="POST" action="{{ route('article.post-update') }}" enctype="multipart/form-data" id="article_form" name="article_form">
                        ...
                        <div class="two fields">
                            <div class="field">
                                ...
                                <input type="text" name="title" id="title" placeholder="标题" value="{{$info->title}}">
                            </div>
                            <div class="field">
                                <label for="slug">别名</label>
                                <input type="text" name="slug" id="slug" placeholder="别名" onblur="checkSlug(this.value)" value="{{$info->slug}}">
                            </div>
                        </div>
                        ...
                        <div class="field">
                            ...
                            <textarea rows="2" name="intro" id="intros">{{ $info->intro }}</textarea>
                        </div>

                        <div class="field" id="editormd">
                            <label for="body-field"></label>
                            <textarea rows="15" id="body-field" name="content" style="display:none;">{{ $info->content }}</textarea>
                        </div>

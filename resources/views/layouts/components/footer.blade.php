    ...
    <div class="ui center aligned container">
        <div class="ui stackable inverted divided grid">
            ...
            <div class="four wide column">
                ...
                <div class="ui inverted link list">
                    <span class="item" id="users_count"></span>
                    <span class="item" id="pages_count"></span>
            ...
            <div class="four wide column">
                <h4 class="ui inverted header">分享</h4>
                <div class="ui inverted link list">
                    <a id="weibo-share" class="item"><i class="share alternate icon"></i>&nbsp;&nbsp;分享到微博</a>
                </div>
            </div>
        </div>
    </div>
